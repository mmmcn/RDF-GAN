...
class NYUV2R2RDataset(BaseDataset):
    ...
    def load_test_file(self):
        with open('/home/private/Software/3d-detection-repos/mm-fusion-3d/data/nyuv2/test.txt', 'r') as f:
            indices = f.read().splitlines()

        rgb_file_list = [f'/home/private/Software/3d-detection-repos/mm-fusion-3d/data/nyuv2/test/rgb/{idx}.png' for idx in indices]
        raw_depth_file_list = [f'/home/private/Software/3d-detection-repos/mm-fusion-3d/data/nyuv2/test/depth_raw/{idx}.png' for idx in indices]
        depth_file_list = [f'/home/private/Software/3d-detection-repos/mm-fusion-3d/data/nyuv2/test/depth/{idx}.png' for idx in indices]
